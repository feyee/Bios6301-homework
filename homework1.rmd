...
```
Intercept standard error 1.098701
Gender standard error 1.474061
...
```{r}
pt(2.917, df = 7, lower.tail = FALSE) * 2
0.02243567
```
...
Lets compare the results of our model to a two-sample t-test.  We
...
```{r}
t.test(women[,'los'], y = men[,'los'])
t.test(women[,'los'], y = men[,'los'], var.equal = TRUE) #this p value matches the model summary
```
